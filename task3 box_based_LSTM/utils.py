...
def save_checkpoint(epoch, epochs_since_improvement, model, optimizer, loss, best_F1, is_best):
    """
    ...
    :param best_F1: best validation loss achieved so far (not necessarily in this checkpoint)
